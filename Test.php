...
use pocketmine\level\generator\FlatNormal;
...
class Server{
	...
	public function getName() : string{
		return "§l§aElite§dCore§7  §r⋗ §l§e0.0.3 private§f";#LiteCore-mod v1.0.5-release
		#return "§l§aＥｌｉｔｅ§dＣｏｒｅ§7 §r⋗ §l§ev0.0.3-private§f";
	}
	...
	public function getVkcore(){
		return \pocketmine\VK_CORE;
	}
	...
	public function about(){
		...
		$string = "
§6┌────────────────────────────────────────────────┐
§6│									   Страница авторских прав
§6│		§a╔═══╗╔╗§7──§a╔══╗╔════╗╔═══╗§d╔══╗╔══╗╔═══╗╔═══╗
§6│		§a║╔══╝║║§7──§a╚╗╔╝╚═╗╔═╝║╔══╝§d║╔═╝║╔╗║║╔═╗║║╔══╝
§6│		§a║╚══╗║║§7───§a║║§7───§a║║§7──§a║╚══╗§d║║§7──§d║║║║║╚═╝║║╚══╗
§6│		§a║╔══╝║║§7───§a║║§7───§a║║§7──§a║╔══╝§d║║§7──§d║║║║║╔╗╔╝║╔══╝
§6│		§a║╚══╗║╚═╗╔╝╚╗§7──§a║║§7──§a║╚══╗§d║╚═╗║╚╝║║║║║§7─§d║╚══╗
§6│		§a╚═══╝╚══╝╚══╝§7──§a╚╝§7──§a╚═══╝§d╚══╝╚══╝╚╝╚╝§7─§d╚═══╝
§6│
§6│								§7Операционная система: §6$os
§6│				§7Версия ядра: §6$version			§7 Билд: §6$code
§6│				§7Версия клиента: §6$mcpe			 	 §7IP: §6
§6│				§7Требуется PHP: §6$min_php			 	 §7Используеться PHP: §6$php
§6│
§6│				§7Миров: §63								§7Плагинов: §674
§6│				§7Игроков: §61106			 	 		§7Операторов: §63
§6│				§7Белый лист: §62			 	 		§7Забанено: §6201
§6│				§7Забанено по IP: §673					§7Забанено по CID: §67
§6│
§6│						§7  Автор: §6YouTuBeR Play §7- §3vk.com/youtuber_play
§6│		§7   Это ядро сделано для проектов от §aYouTuBeR Play §7& §dStacreeper
§6│	§7  Основные проекты: §avk.com/CraftDay_server §7& §dvk.com/KrepWorld_server
§6└────────────────────────────────────────────────┘";
	...
	public function checkup(){
		...
		if (\pocketmine\CORE_VERSION == $check1) {
			$this->getLogger()->warning('У Вас стоит §aактуальная §fверсия ядра EliteCore');
		}elseif (\pocketmine\CORE_VERSION < $check1) {
			$this->getLogger()->warning('У Вас стоит §cустаревшая §fверсия ядра EliteCore');
		}
	}
	...
	public function __construct(\ClassLoader $autoloader, \ThreadedLogger $logger, $dataPath, $pluginPath, $defaultLang = "unknown"){
		...
		try{
			...
			//$this->checkup();//проверка актуальной версии ядра
			$this->about();
			...
			Generator::addGenerator(FlatNormal::class, "flat2");
	...
	private function tick() : void{
		...
		#$this->currentUse = min(10,($now - $tickTime) / 1.90);#подкрутка))) п.с. не бейте))
